...
app = FastAPI(
    ...
    version="0.2.5-carga-dian-conexion-fresca",
    lifespan=_lifespan,
...
@app.get("/salud")
async def salud():
    # Debe responder directamente desde el event loop. Las cargas DIAN pesadas
    # se ejecutan en el threadpool y no deben impedir el health check de Render.
    return {"status": "ok"}
